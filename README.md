...
- git init: Khai báo một dự án bắt đầu sử dụng git ( tạo một repository local cho dự án)
...
- git remote add origin https://github.com/caotv1512/git-flow.git : Tạo liên kết giữa repo local và repo server trên gitlab hoặc github
